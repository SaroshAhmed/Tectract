...
<section class="herosection">
    <div class="controls-parent">
        <div class=" app-project-1 project-active carousalbanner1">
...
<section class="body-section">
    <!-- Credits Section -->
    <div class=" credit-sec py-5">
        <div class="findus-container">
            <div class="d-flex jusify-content-center align-items-center">
                <h3>Delivering tech Solutions <a>Globally</a></h3>

            </div>
        </div>
        <div class="credit-inner d-flex justify-content-center align-items-center gap-5">
            <!-- <img src="assets/front/images/barkwhite.png" class="img-fluid" alt="Image 1"> -->
            <!-- <div>
                <h2 class="mt-3">bark</h2>
            </div> -->
            <img src="assets/front/images/barkreview.png" class="img-fluid" alt="Find us at Clutch">
            <img src="assets/front/images/clutchwhite.svg" class="img-fluid" alt="Find us at Clutch">
            <img src="assets/front/images/googlep.webp" class="img-fluid" alt="Find us at Google">
            <img src="assets/front/images/yelp.png" class="img-fluid" alt="Find us at Yelp">
            <img src="assets/front/images/trustwhite.webp" class="img-fluid" alt="Find us at trust">
        </div>
        <div class="container dividerline"></div>
    ...
    <section class="py-5">
        ...
        <div class="py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <img src="assets/front/images/aboutuslp.png" class="img-fluid" alt="Find us at trust">
                    </div>
                    <div class="col-md-6 col-12">
                        <h1>
    ...
    <section class="pb-5">
        <div class="container">
            <h3 class="subhead">Core Services We Provide</h3>
            <h1>Discover a range of services crafted for your needs</h1>
        </div>
        <div class="container mt-5">
            <div class="service-slider">
                <div class="service-card py-5">
                    ...
                    <div class="d-flex justify-content-center align-items-center ">
                        <div class="services-btn-container">
                            <a href="" class="maincta2">Explore <i class="fa-solid fa-circle-arrow-right mx-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="service-card py-5">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
                    <img src="assets/front/images/dashboard.png" class="img-fluid" alt="app development services">
                    <div class="d-flex justify-content-center align-items-center ">
                        <div class="services-btn-container">
                            <a href="" class="maincta2">Explore <i class="fa-solid fa-circle-arrow-right mx-2"></i></a>
                        </div>
                ...
                <div class="service-card py-5">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
                    <img src="assets/front/images/webservice.png" class="img-fluid" alt="web development services">
                    <div class="d-flex justify-content-center align-items-center ">
                        <div class="services-btn-container">
                            <a href="" class="maincta2">Explore <i class="fa-solid fa-circle-arrow-right mx-2"></i></a>
                        </div>
                ...
                <div class="service-card py-5">
                    <h3>SEO Services</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
                    <img src="assets/front/images/seobanner.png" class="img-fluid" alt="seo services">
                    <div class="d-flex justify-content-center align-items-center ">
                        <div class="services-btn-container">
                            <a href="" class="maincta2">Explore <i class="fa-solid fa-circle-arrow-right mx-2"></i></a>
                        </div>
                ...
                <div class="service-card py-5">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit...</p>
                    <div class="d-flex justify-content-center align-items-center ">
                        <img src="assets/front/images/brandservice.png" class=" brandser" alt="seo services">
                    </div>
                    <div class="d-flex justify-content-center align-items-center ">
                        <div class="services-btn-container">
                            <a href="" class="maincta2">Explore <i class="fa-solid fa-circle-arrow-right mx-2"></i></a>
                        ...
                        <div id="carouselExampleSlidesOnlyApp" data-bs-interval="3000" class="carousel slide " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <img src="assets/front/images/mbban2.png" class="screen-apps mx-5" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/front/images/mbban2.png" class="screen-apps" alt="...">
                                    <img src="assets/front/images/mbban1.png" class="screen-apps mx-5" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/front/images/mbban1.png" class="screen-apps" alt="...">
                                    <img src="assets/front/images/mbban1.png" class="screen-apps mx-5" alt="...">
